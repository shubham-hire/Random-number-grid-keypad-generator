(() => {
  ...
  const e = "__brackets-ld-highlight",
    t = { "background-color": "rgba(0, 162, 255, 0.5)", opacity: 0 },
    o = { "background-color": "rgb(106, 171, 233)", opacity: 0.6 },
    n = { "background-color": "rgb(156, 221, 156)" },
    r = { "background-color": "rgb(255 ,177 ,95)" },
  ...
  let d, c;
  const p = function (e) {
    d && (window.cancelAnimationFrame(d), window.clearTimeout(c)),
      (d = window.requestAnimationFrame(l)),
      (c = setTimeout(function () {
        window.cancelAnimationFrame(d), (d = null);
      }, 1e3 * e));
  };
  class f {
    constructor(e) {
    ...
    elementExists(e) {
      let t;
      for (t in this.elements) if (this.elements[t] === e) return !0;
      return !1;
    }
    makeHighlightDiv(a, l) {
      ...
      if ((u && p(u), g && p(g), 0 === d.width && 0 === d.height)) return;
      const h = {
      ...
      let y = parseFloat(f.width),
        ...
        v = y;
      m ||
        ((y += parseFloat(f.paddingLeft) + parseFloat(f.paddingRight)),
      ...
      const x = { horizontal: "left, right", vertical: "top, bottom" },
        F = function (e) {
          const t = {};
          return (
            x.horizontal.indexOf(e) >= 0
              ? ((t.width = f.getPropertyValue("padding-" + e)),
                (t.height = w + "px"),
                (t.top = 0),
                m &&
                  (t.height =
                    w - parseFloat(h.top) - parseFloat(h.bottom) + "px"))
              : ((t.height = f.getPropertyValue("padding-" + e)),
                (t.width = y + "px"),
                (t.left = 0),
                m &&
                  (t.width =
                    y - parseFloat(h.left) - parseFloat(h.right) + "px")),
            (t[e] = 0),
            (t.position = "absolute"),
            t
          );
        ...
        P = function (e) {
          const t = {},
            o = [];
          return (
            (o.right = parseFloat(f.getPropertyValue("margin-right"))),
            ...
            x.horizontal.indexOf(e) >= 0
              ? ((t.width = f.getPropertyValue("margin-" + e)),
                (t.height = b + o.top + o.bottom + "px"),
                (t.top = "-" + (o.top + parseFloat(h.top)) + "px"))
              : ((t.height = f.getPropertyValue("margin-" + e)),
                (t.width = v + "px"),
                (t.left = "-" + h.left)),
        ...
        S = function (e) {
          !s || parseInt(e.height, 10) <= 0 || parseInt(e.width, 10) <= 0
            ? (e.display = "none")
            : (e.display = "block");
        },
        ...
        k = function (e, t) {
          ...
          for (o = 0; o < e.length; o++) {
            S(e[o]), (e[o].transform = "none");
            const n = window.document.createElement("div");
            R(Object.assign({}, t, e[o]), n.style), c.appendChild(n);
          }
        };
      k([P("top"), P("right"), P("bottom"), P("left")], r),
        ...
        (function (e) {
          ...
          if ("static" === window.getComputedStyle(o).position)
            (r = t.left + window.pageXOffset), (n = t.top + window.pageYOffset);
          else {
            const e = o.getBoundingClientRect();
            (r = t.left - e.left), (n = t.top - e.top);
          }
        })(a);
      let O = a,
        T = 0,
        C = 0;
      do {
        (T += O.offsetLeft), (C += O.offsetTop), (O = O.offsetParent);
      } while (O);
      const H = {
          left: T + "px",
          top: C + "px",
      ...
      function R(e, t) {
        let o;
        for (o in e) t.setProperty(o, e[o]);
      }
      R(V, c.style),
        R(l ? L : M, c.style),
        l &&
    ...
    add(e, t) {
      if (!this.elementExists(e) && e !== window.document) {
        if (
          (this.trigger,
          (!window.event || window.event instanceof MessageEvent) &&
            !(function (e) {
              const t = e.getBoundingClientRect(),
              ...
              return (
                t.top >= 0 &&
                t.left >= 0 &&
                t.bottom <= (window.innerHeight || o.clientHeight) &&
                t.right <= (window.innerWidth || o.clientWidth)
              );
            })(e))
        ) {
          let t = a(e);
          t && ((t -= window.innerHeight / 2), window.scrollTo(0, t));
        }
        this.elements.push(e), this.makeHighlightDiv(e, t);
      }
    }
    clear() {
      let t;
      ...
      for (t = 0; t < o.length; t++) n.removeChild(o[t]);
      if (this.trigger)
        for (t = 0; t < this.elements.length; t++) this.elements[t];
      this.elements = [];
    }
    redraw() {
      let e, t;
  ...
  let g;
  const h =
    !!document.body && document.body.hasAttribute("data-server-no-reload");
  h &&
    console.info(
      "[Five Server] Reload disabled due to 'data-server-no-reload' attribute on BODY element"
    ),
    "WebSocket" in window &&
      !h &&
      window.addEventListener("load", () => {
        ...
        r &&
          "true" === r.toString() &&
          (g = document.body ? document.body.cloneNode(!0) : void 0);
        let i = null;
        const s = new f(!0);
        s.redraw(),
        ...
        let l,
          ...
          p = "";
        const h = (e, t, o = {}) => {
            const n = JSON.stringify({ message: e, type: t, options: o });
            if (p === n && "css updated" !== e) return;
            p = n;
            ...
            (l.id = "fiveserver-info"),
              ...
              "error" === t
                ...
                : a
                ? ((r.style.top = "-40px"),
                  (r.style.animation = `fiveserverInfoPopup ${s}s forwards`))
                : ((r.style.top = "4px"), (r.style.animation = "")),
              "success" === t
                ? ((l.style.color = "#498d76"),
                  (l.style.backgroundColor = "#00ffa9"))
                : "info" === t &&
                  ((l.style.color = "#d2e1f0"),
                  (l.style.backgroundColor = "#2996ff")),
              (l.innerHTML = e.replace(/</gm, "&lt;"));
          },
          m = (e, ...t) => {
            l &&
              1 === (null == l ? void 0 : l.readyState) &&
              l.send(JSON.stringify({ console: { type: e, message: t } }));
          },
          y = (e) => {
            ...
            o = o.filter(
              (e) =>
                /\.css/gm.test(e.href) || "stylesheet" == e.rel.toLowerCase()
            );
        ...
        const F = (e) => {
            if ("HIDE" === e || "HIDE_MESSAGE" === e || "HIDE_MESSAGES" === e) {
              ...
              e && e.remove();
            } else h(e, "info", { animation: !1 });
          },
          P = () => {
            (l = new WebSocket(o)),
              (l.onmessage = function (t) {
                if (((d = 1e3), (c = 0), "reload" === t.data))
                  window.location.reload();
                else if ("refreshcss" === t.data) y(!0);
                else if ("refreshcss-silent" === t.data) y(!1);
                  ...
                  (() => {
                    ...
                    console.warn = function (...e) {
                      m("warn", ...e), t.apply(console, e);
                    };
                    const o = console.error;
                    console.error = function (...e) {
                      m("error", ...e), o.apply(console, e);
                    };
                  })();
                else {
                          ...
                          u(void 0, void 0, void 0, function* () {
                            if (
                              ("" === b &&
                                (yield ((b = "loading"),
                                new Promise((t) => {
                                  const o = new URL(e.src).pathname
                                      .split("/")
                                      .slice(0, -1)
                                      .join("/"),
                                    n = `//${
                                      new URL(e.src).host
                                    }${o}/fiveserver/scripts/diffDOM/diffDOM.js`,
                              ...
                              try {
                                ...
                                if (
                                  ...
                                  for (
                                    let e = 0;
                                    e < o.attributes.length;
                                    e++
                                  ) {
                                    const t = o.attributes.item(e);
                                    if (t) {
                                      const e = document.createAttribute(
                                        t.name
                                      );
                                      (e.value = t.value),
                                ...
                                (x = !0),
                                  F(
                                    "Having issues parsing the DOM.\nPlease verify that your HTML is valid..."
                                  );
                              }
                          });
                        })(n.body)
                      : n.body && ((o = n.body), (document.body.innerHTML = o)),
                    n.messages &&
                      ((e) => {
                        F(e.join("\n\n"));
                      })(n.messages),
              ...
              (l.onopen = function () {
                if (c > 0) return void window.location.reload();
                const e = document.querySelectorAll("script");
                for (let t = 0; t < e.length; t++) {
                  const o = e[t];
                  o.dataset &&
                    o.dataset.file &&
                    l.send(JSON.stringify({ file: o.dataset.file }));
                }
        ...
        const E = () => {
          ...
          k = () =>
            u(void 0, void 0, void 0, function* () {
              S++;
              const t = `${new URL(e.src).protocol}//${
                new URL(e.src).host
              }${new URL(e.src).pathname
                .split("/")
                .slice(0, -1)
                .join("/")}/fiveserver/status`;
              try {
                const e = yield fetch(t),
                  o = yield e.json();
                o && o.status && "online" === o.status ? (P(), (S = 0)) : E();
              } catch (e) {
                E();
              }
            });
